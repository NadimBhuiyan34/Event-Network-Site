                    ...
                    <form class="card-body cardbody-color p-lg-5" method="post" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            <select name="country" class="form-control">
                                ...
                                <option value="['Bolivia, Plurinational State of','BO']">"Bolivia, Plurinational State
                                    of"
                                </option>
                                ...
                                <option value="['Korea, Democratic People's Republic of','KP']">"Korea, Democratic
                                    People's
                                    Republic of"</option>
                                ...
                                <option value="['Lao People`s Democratic Republic','LA']">Lao People's Democratic
                                    Republic
                                </option>
                                ...
                                <option value="['Macedonia, the Former Yugoslav Republic of','MK']">"Macedonia, the
                                    Former
                                ...
                                <option value="['Micronesia, Federated States of','FM']">"Micronesia, Federated States
                                    of
                                </option>
                                ...
                                <option value="['South Georgia and the South Sandwich Islands','GS']">South Georgia and
                                    the
                                ...
                                <option value="['United States Minor Outlying Islands','UM']">United States Minor
                                    Outlying
                                    Islands</option>
                                <option value="['Uruguay','UY']">Uruguay</option>
                                <option value="['Uzbekistan','UZ']">Uzbekistan</option>
                                <option value="['Vanuatu','VU']">Vanuatu</option>
                                <option value="['Venezuela, Bolivarian Republic of','VE']">"Venezuela, Bolivarian
                                    Republic
                                    of"</option>
                        ...
                        <div id="emailHelp" class="form-text text-center mb-5 text-dark">Allready register<a
                                href="{{ route('login.page') }}" class="text-dark fw-bold"> Login</a>
                        </div>
                </div>
                </form>
            </div>
