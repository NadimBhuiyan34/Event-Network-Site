          ...
          <div class="profile-header">
              ...
              <div class="profile-header-content">
                  <div class="profile-header-img mb-4">
                      <img src="{{ asset('storage/image/profiles/' . Auth::user()->profile_image) }}" class="mb-4" alt="" />
                  </div>
                                      ...
                                      <div class="col-md-6 col-lg-6 col-xl-6 mb-3">
                                          <div class="card text-black">
                                              <div class="d-flex justify-content-between">
                                                  <span class="badge bg-danger w-25 mt-2 shadow p-2">{{ $event->date }}</span>
                                                  <div class="dropdown">
                                                      ...
                                                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                          ...
                                                          <button type="button" class="dropdown-item text-success" data-bs-toggle="modal" data-bs-target="#myModal">
                                                              Edit
                                                          </button>
                                                  ...
                                                  <div class="modal-dialog modal-lg">
                                                      <div class="modal-content">
                                                          ...
                                                          <div class="modal-body">
                                                              <form id="eventForm" action="{{ route('events.update', ['event' => $event->id]) }}" enctype="multipart/form-data" method="POST">
                                                                  @csrf
                                                                  @method('PATCH')
                                                                  ...
                                                                  <div class="form-group row mb-2">
                                                                      <label for="endTime" class="col-sm-2 col-form-label">Start
                                                                          Time:</label>
                                                                      <div class="col-sm-4">
                                                                          <input type="time" class="form-control" id="endTime" name="startTime" value="{{ $event->start_time }}" required>
                                                                      </div>
                                                                      <label for="startTime" class="col-sm-2 col-form-label">End
                                                                          Time:</label>
                                                                      <div class="col-sm-4">
                                                                          <input type="time" class="form-control" id="startTime" name="endTime" value="{{ $event->end_time }}" required>
                                                                      </div>
                                                                  </div>
                                                                  <div class="form-group row mb-2">
                                              ...
                                              <img src="{{ asset('storage/image/events/' . $event->banner_image) }}" class="card-img-top" alt="Apple Computer" />
                                              ...
                                              <div class="card-body">
                                                  ...
                                                  <div>
                                                      <div class="">
                                                          <span class="text-danger">{{ $event->category->title }}</span>
                                                      </div>
                                                      <div class="">
                                                          <h6>{{ $event->title }}</h6>
                                                      </div>
                                                      ...
                                                      <div class="pt-2">
                                                          <a href="{{ route('events.show', ['event' => $event->id]) }}" class="btn btn-outline-dark btn-sm">More Details</a>
                                                          <button class="btn btn-sm btn-outline-dark favouriteBtn" data-id={{ $event->id }}> Add Favourite<i class="fas fa-heart fa-xl ms-2 text-danger"></i></button>
                                                      </div>
                                                  </div>
