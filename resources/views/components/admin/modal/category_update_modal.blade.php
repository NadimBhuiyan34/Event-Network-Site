<div class="modal fade" id="cateoryUpdateModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer shadow">
                    <button type="button" class="btn btn-success m-auto w-50 add_category btn-sm add_category" id="updateButton">Update <i
